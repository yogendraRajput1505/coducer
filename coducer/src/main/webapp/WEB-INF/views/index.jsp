                ...
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        <li class="nav-item">
                            ...
                            <a href="login"><button class="btn bg-info pt-2 pb-2">Login</button></a>
                        </li>
                        <li class="nav-item">
                            <!-- <a class="nav-link"><i class="fab fa-twitter"></i></a> -->
                            <a href="signup"><button class="btn bg-info pt-2 pb-2">Sign Up</button></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-12">
                        ...
                        <div id="map-container" class="z-depth-1-half map-container mb-5" style="height: 400px">
                            <iframe src="https://maps.google.com/maps?q=chicago&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="border:0" allowfullscreen width="100%" height="100%"></iframe>
                        </div>
