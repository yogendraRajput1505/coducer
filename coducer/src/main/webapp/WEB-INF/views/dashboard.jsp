  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        <img src="https://www.logodesign.net/logo/abstract-people-3205ld.png?size=2&industry=employee" class="img-fluid" alt="">
      </a>
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action waves-effect" data-toggle="modal" data-target="#centralModalLGInfoDemo">
                ...
                <div class="modal-dialog modal-side modal-top-left modal-notify modal-info" role="document">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <img src="https://www.logodesign.net/logo/abstract-people-3205ld.png?size=2&industry=employee" alt="Employee - dashboard"
                        class="img-fluid">
              ...
              <div class="modal fade" id="centralModalLGInfoDemo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
                  ...
                  <div class="modal-content">
                    <!--Header-->
                    <div class="modal-header">
                      <p class="heading lead">Personal Details </p>
